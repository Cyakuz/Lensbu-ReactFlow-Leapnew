...
```bash
git remote add encore encore://microscope-rpg-app-r2t2
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/microscope-rpg-app-r2t2/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/microscope-rpg-app-r2t2/settings/integrations/github)
